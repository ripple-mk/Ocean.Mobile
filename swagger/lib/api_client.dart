...
class ApiClient {
  ...
  ApiClient({this.basePath = 'http://localhost:5001'}) {
  ...
  dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'RippleOceanServicesFeaturesAccountsChangePasswordRequest':
        ...
        case 'RippleOceanServicesFeaturesAccountsLoginResponse':
          return RippleOceanServicesFeaturesAccountsLoginResponse.fromJson(value);
        case 'RippleOceanServicesFeaturesAccountsRegisterRequest':
          return RippleOceanServicesFeaturesAccountsRegisterRequest.fromJson(value);
        case 'RippleOceanServicesFeaturesAccountsRegisterResponse':
        ...
        case 'RippleOceanServicesFeaturesQuestionsAnswerResponse':
          return RippleOceanServicesFeaturesQuestionsAnswerResponse.fromJson(value);
        case 'RippleOceanServicesFeaturesQuestionsMultipleAnswersRequest':
          return RippleOceanServicesFeaturesQuestionsMultipleAnswersRequest.fromJson(value);
        case 'RippleOceanServicesFeaturesQuestionsMultipleAnswersResponse':
        ...
        case 'RippleOceanServicesFeaturesResultsStartResponseQuestion':
          return RippleOceanServicesFeaturesResultsStartResponseQuestion.fromJson(value);
        default:
          Match match;
          if (value is List && (match = _regList.firstMatch(targetType)) != null) {
            final newTargetType = match[1];
            return value.map((v) => _deserialize(v, newTargetType, growable: growable)).toList(growable: true == growable);
          }
          if (value is Set && (match = _regSet.firstMatch(targetType)) != null) {
            final newTargetType = match[1];
            return value.map((v) => _deserialize(v, newTargetType, growable: growable)).toSet();
          }
  ...
  dynamic deserialize(String json, String targetType, {bool growable}) {
    ...
    return targetType == 'String' ? json : _deserialize(jsonDecode(json), targetType, growable: true == growable);
  }
  ...
  void _updateParamsForAuth(
    ...
    if (token.isNotEmpty) {
      HttpBearerAuth bearerAuth = getAuthentication("Bearer");
